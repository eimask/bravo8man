...
( function() {
	...
	function alignCommandIntegrator( editor ) {
		...
		return function( value ) {
			...
			// This commands will be manually refreshed along with
	...
	function linkCommandIntegrator( editor ) {
		...
		// Overwrite default behaviour of unlink commands.
		editor.getCommand( 'unlink' ).on( 'exec', function( evt ) {
			...
			// i.e. if captioned image. Let's refresh commands state manually here.
			this.refresh( editor, editor.elementPath() );

			evt.cancel();
		} );

		// Overwrite default refresh of unlink commands.
