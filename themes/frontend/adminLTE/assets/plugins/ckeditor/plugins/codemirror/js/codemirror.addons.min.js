...
g.to}return!0}b.defineOption("autoCloseTags",!1,function(a,c,e){if(e!=b.Init&&e&&a.removeKeyMap("autoCloseTags"),c){e={name:"autoCloseTags"};(typeof c!="object"||c.whenClosing)&&(e["'/'"]=function(a){return g(a)});(typeof c!="object"||c.whenOpening)&&(e["'>'"]=function(a){return j(a)});a.addKeyMap(e)}});var a="area base br col commands embed hr img input keygen link meta param source track wbr".split(" "),c="applet blockquote body button div dl fieldset form frameset h1 h2 h3 h4 h5 h6 head html iframe layer legend object ol p select table ul".split(" ")});
